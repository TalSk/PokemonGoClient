...
# source: Enums/PokemonEnums.proto
...
_POKEMONID = _descriptor.EnumDescriptor(
  name='PokemonId',
  full_name='Protos.Enums.PokemonId',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_POKEMONFAMILYID = _descriptor.EnumDescriptor(
  ...
  full_name='Protos.Enums.PokemonFamilyId',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_CATCHSTATUS = _descriptor.EnumDescriptor(
  name='CatchStatus',
  full_name='Protos.Enums.CatchStatus',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_CATCHSTATUS)

CatchStatus = enum_type_wrapper.EnumTypeWrapper(_CATCHSTATUS)
MOVE_UNSET = 0
THUNDER_SHOCK = 1
QUICK_ATTACK = 2
SCRATCH = 3
...
DESCRIPTOR.enum_types_by_name['CatchStatus'] = _CATCHSTATUS
