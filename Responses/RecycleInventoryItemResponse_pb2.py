...
# source: Responses/RecycleInventoryItemResponse.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='Responses/RecycleInventoryItemResponse.proto',
  package='Protos.Responses',
  syntax='proto3',
  serialized_pb=_b('\n,Responses/RecycleInventoryItemResponse.proto\x12\x10Protos.Responses\"\xdc\x01\n\x1cRecycleInventoryItemResponse\x12\x45\n\x06result\x18\x01 \x01(\x0e\x32\x35.Protos.Responses.RecycleInventoryItemResponse.Result\x12\x11\n\tnew_count\x18\x02 \x01(\x05\"b\n\x06Result\x12\t\n\x05UNSET\x10\x00\x12\x0b\n\x07SUCCESS\x10\x01\x12\x1b\n\x17\x45RROR_NOT_ENOUGH_COPIES\x10\x02\x12#\n\x1f\x45RROR_CANNOT_RECYCLE_INCUBATORS\x10\x03\x62\x06proto3')
)
...
_RECYCLEINVENTORYITEMRESPONSE_RESULT = _descriptor.EnumDescriptor(
  name='Result',
  full_name='Protos.Responses.RecycleInventoryItemResponse.Result',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_RECYCLEINVENTORYITEMRESPONSE = _descriptor.Descriptor(
  ...
  full_name='Protos.Responses.RecycleInventoryItemResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='result', full_name='Protos.Responses.RecycleInventoryItemResponse.result', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='new_count', full_name='Protos.Responses.RecycleInventoryItemResponse.new_count', index=1,
...
RecycleInventoryItemResponse = _reflection.GeneratedProtocolMessageType('RecycleInventoryItemResponse', (_message.Message,), dict(
  ...
  __module__ = 'Responses.RecycleInventoryItemResponse_pb2'
  # @@protoc_insertion_point(class_scope:Protos.Responses.RecycleInventoryItemResponse)
  ))
