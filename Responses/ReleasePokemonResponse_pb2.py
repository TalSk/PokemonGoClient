...
# source: Responses/ReleasePokemonResponse.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='Responses/ReleasePokemonResponse.proto',
  package='Protos.Responses',
  syntax='proto3',
  serialized_pb=_b('\n&Responses/ReleasePokemonResponse.proto\x12\x10Protos.Responses\"\xce\x01\n\x16ReleasePokemonResponse\x12?\n\x06result\x18\x01 \x01(\x0e\x32/.Protos.Responses.ReleasePokemonResponse.Result\x12\x15\n\rcandy_awarded\x18\x02 \x01(\x05\"\\\n\x06Result\x12\t\n\x05UNSET\x10\x00\x12\x0b\n\x07SUCCESS\x10\x01\x12\x14\n\x10POKEMON_DEPLOYED\x10\x02\x12\n\n\x06\x46\x41ILED\x10\x03\x12\x18\n\x14\x45RROR_POKEMON_IS_EGG\x10\x04\x62\x06proto3')
)
...
_RELEASEPOKEMONRESPONSE_RESULT = _descriptor.EnumDescriptor(
  name='Result',
  full_name='Protos.Responses.ReleasePokemonResponse.Result',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_RELEASEPOKEMONRESPONSE = _descriptor.Descriptor(
  ...
  full_name='Protos.Responses.ReleasePokemonResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='result', full_name='Protos.Responses.ReleasePokemonResponse.result', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='candy_awarded', full_name='Protos.Responses.ReleasePokemonResponse.candy_awarded', index=1,
...
ReleasePokemonResponse = _reflection.GeneratedProtocolMessageType('ReleasePokemonResponse', (_message.Message,), dict(
  ...
  __module__ = 'Responses.ReleasePokemonResponse_pb2'
  # @@protoc_insertion_point(class_scope:Protos.Responses.ReleasePokemonResponse)
  ))
