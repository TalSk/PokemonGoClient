...
_PLAYERCAMERA = _descriptor.Descriptor(
  name='PlayerCamera',
  full_name='Protos.Player.PlayerCamera',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='is_default_camera', full_name='Protos.Player.PlayerCamera.is_default_camera', index=0,
...
PlayerCamera = _reflection.GeneratedProtocolMessageType('PlayerCamera', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:Protos.Player.PlayerCamera)
  ))
