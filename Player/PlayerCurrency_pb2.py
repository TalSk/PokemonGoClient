...
_PLAYERCURRENCY = _descriptor.Descriptor(
  name='PlayerCurrency',
  full_name='Protos.Player.PlayerCurrency',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='gems', full_name='Protos.Player.PlayerCurrency.gems', index=0,
...
PlayerCurrency = _reflection.GeneratedProtocolMessageType('PlayerCurrency', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:Protos.Player.PlayerCurrency)
  ))
