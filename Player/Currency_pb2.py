...
_CURRENCY = _descriptor.Descriptor(
  name='Currency',
  full_name='Protos.Player.Currency',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='Protos.Player.Currency.name', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='amount', full_name='Protos.Player.Currency.amount', index=1,
...
Currency = _reflection.GeneratedProtocolMessageType('Currency', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:Protos.Player.Currency)
  ))
